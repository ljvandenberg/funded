...
export const CASES: Case[] = [
  {
    ...
    objective: "capital",
    objectiveText:
      "You need cash for a production kitchen and food-safety certification. You score on net coins after reward costs.",
  },
  {
    id: "cheese",
    name: "Cheese & Boom",
    ...
    objectiveText:
      "You need to know if strangers would buy this. You score on coins from outside your own team.",
  },
  {
    id: "beacon",
    name: "Beacon",
  ...
  },
  {
    ...
    objective: "marketing",
    objectiveText:
      "You need an audience for the release. You score on reach: number of different backers plus shares.",
  },
  {
    id: "grow",
    name: "Grow",
    ...
    objective: "capital",
    objectiveText:
      "You need money for the first production run. You score on net coins after reward costs.",
  },
  {
    id: "beanpost",
    name: "Beanpost",
    ...
    objective: "marketing",
    objectiveText:
      "You need awareness, not money. You score on reach: different backers plus shares.",
  },
  {
    id: "chatter",
    name: "Chatter",
    ...
    objective: "validation",
    objectiveText: "You score on coins from outside your own team.",
  },
  {
    id: "cloudlet",
    name: "Cloudlet",
    ...
    objective: "capital",
    objectiveText: "You score on net coins after reward costs.",
  },
];
